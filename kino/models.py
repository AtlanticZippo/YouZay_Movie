...
class Category(models.Model):
    name = models.CharField("Категория", max_length=170)
...
class Movie(models.Model):
    ...
    tagline = models.CharField("Слоган", max_length=180, default='')
    description = models.TextField("Описание")
    poster = models.ImageField("Постер", upload_to="kino/")
    ...
    def get_reviews(self):
        return self.reviews_set.filter(parent__isnull=False)
    class Meta:
        verbose_name = "Фильм"
